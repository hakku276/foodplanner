...
public class LoadActiveShoppingCartItemsAsync extends AsyncTask<Void, Void, List<CartItem>> {

    private static final String TAG = LoadActiveShoppingCartItemsAsync.class.getSimpleName();
    ...
    public LoadActiveShoppingCartItemsAsync(@NonNull ShoppingCartDao dao, @NonNull Listener listener) {
        this.dao = dao;
